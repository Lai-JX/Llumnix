...
Llumnix_benchmark() {
    ...
    HEAD_NODE=1 python -m llumnix.entrypoints.vllm.api_server \
                    ...
                    --log-filename $BASE_DIR/serve_$count\_tp$TP\_$REQ_NUM > output1.log 2>&1 &
    sleep 5
    # 启动实例
    count=$(($count - 1))
    for ((i=0; i < count; i++)); do
        ...
        python -m llumnix.entrypoints.vllm.api_server \
                    ...
                    --log-instance-info \
                    --tensor-parallel-size $TP \
                    --log-filename $BASE_DIR/serve_$((count + 1))\_tp$TP\_$REQ_NUM > output2.log 2>&1 &
    done
    ...
    python /workspace/llm-serve/Llumnix/benchmark/benchmark_serving.py \
        ...
        --log_filename $BASE_DIR/benchmark_$((count + 1))\_tp$TP\_$REQ_NUM
...
Llumnix_benchmark_pdd() {
    ...
    HEAD_NODE=1 python -m llumnix.entrypoints.vllm.api_server \
                ...
                --log-instance-info \
                --tensor-parallel-size $TP \
                --log-filename $BASE_DIR/serve_pdd_tp$TP\_$REQ_NUM\_$prefill_count\_$decode_count > output1.log 2>&1 &
    sleep 5
    # 启动 prefill 实例
    ...
    for ((i=0; i < prefill_count; i++)); do
        ...
        python -m llumnix.entrypoints.vllm.api_server \
                    ...
                    --log-instance-info \
                    --tensor-parallel-size $TP \
                    --log-filename $BASE_DIR/serve_pdd_tp$TP\_$REQ_NUM\_$((prefill_count + 1))\_$decode_count > output1.log 2>&1 &
    done
    ...
    for ((i=0; i < decode_count; i++)); do
        ...
        python -m llumnix.entrypoints.vllm.api_server \
                    ...
                    --log-instance-info \
                    --tensor-parallel-size $TP \
                    --log-filename $BASE_DIR/serve_pdd_tp$TP\_$REQ_NUM\_$((prefill_count + 1))\_$decode_count > output2.log 2>&1 &
    done
    ...
    python /workspace/llm-serve/Llumnix/benchmark/benchmark_serving.py \
        ...
        --fail_on_response_failure \
        --max_request_len 2048 \
        --log_filename $BASE_DIR/benchmark_pdd_tp$TP\_$REQ_NUM\_$((prefill_count + 1))\_$decode_count
