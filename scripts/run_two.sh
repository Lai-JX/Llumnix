...
TP=$1
REQ_NUM=$2
BASE_DIR='/workspace/llm-serve/Llumnix/logs/l40-pdd-4'
nvidia-smi -pl 300
...
Llumnix_benchmark() {
    ...
    HEAD_NODE=1 python -m llumnix.entrypoints.vllm.api_server \
                    ...
                    --log-filename $BASE_DIR/serve_4_tp$1_$2_$3_$4 &
    ...
    # 定义要检查的端口数组
    PORTS_TO_CHECK=(1234 1235 1236 1237)  # 替换为实际需要检查的端口号
    INTERVAL=2
    ...
    python /workspace/llm-serve/Llumnix/benchmark/benchmark_serving.py \
        ...
        --distribution "burst" \
        --log_filename $BASE_DIR/benchmark_4_tp$1_$2_$3_$4
