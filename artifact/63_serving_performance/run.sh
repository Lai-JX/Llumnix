...
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 7.0 poisson 1.0 sharegpt "$dataset_path" balanced 0 0 3 'sharegpt/Round_Robin' $model
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 7.0 poisson 1.0 sharegpt "$dataset_path" load 0 0 3 'sharegpt/INFaas++' $model
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 7.0 poisson 1.0 sharegpt "$dataset_path" load 1 1 3 'sharegpt/Llumnix' $model

bash ./llumnix_exp_dataset ./config/serving_exp_dataset 7.25 poisson 1.0 sharegpt "$dataset_path" balanced 0 0 3 'sharegpt/Round_Robin' $model
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 7.25 poisson 1.0 sharegpt "$dataset_path" load 0 0 3 'sharegpt/INFaas++' $model
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 7.25 poisson 1.0 sharegpt "$dataset_path" load 1 1 3 'sharegpt/Llumnix' $model

bash ./llumnix_exp_dataset ./config/serving_exp_dataset 7.50 poisson 1.0 sharegpt "$dataset_path" balanced 0 0 3 'sharegpt/Round_Robin' $model
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 7.50 poisson 1.0 sharegpt "$dataset_path" load 0 0 3 'sharegpt/INFaas++' $model
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 7.50 poisson 1.0 sharegpt "$dataset_path" load 1 1 3 'sharegpt/Llumnix' $model

bash ./llumnix_exp_dataset ./config/serving_exp_dataset 7.75 poisson 1.0 sharegpt "$dataset_path" balanced 0 0 3 'sharegpt/Round_Robin' $model
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 7.75 poisson 1.0 sharegpt "$dataset_path" load 0 0 3 'sharegpt/INFaas++' $model
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 7.75 poisson 1.0 sharegpt "$dataset_path" load 1 1 3 'sharegpt/Llumnix' $model

bash ./llumnix_exp_dataset ./config/serving_exp_dataset 8.0 poisson 1.0 sharegpt "$dataset_path" balanced 0 0 3 'sharegpt/Round_Robin' $model
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 8.0 poisson 1.0 sharegpt "$dataset_path" load 0 0 3 'sharegpt/INFaas++' $model
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 8.0 poisson 1.0 sharegpt "$dataset_path" load 1 1 3 'sharegpt/Llumnix' $model
...
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 7.50 poisson 1.0 burstgpt './BurstGPT_GPT4-Conversation.csv' balanced 0 0 3 'burstgpt/Round_Robin' $model
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 7.50 poisson 1.0 burstgpt './BurstGPT_GPT4-Conversation.csv' load 0 0 3 'burstgpt/INFaas++' $model
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 7.50 poisson 1.0 burstgpt './BurstGPT_GPT4-Conversation.csv' load 1 1 3 'burstgpt/Llumnix' $model

bash ./llumnix_exp_dataset ./config/serving_exp_dataset 7.75 poisson 1.0 burstgpt './BurstGPT_GPT4-Conversation.csv' balanced 0 0 3 'burstgpt/Round_Robin' $model
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 7.75 poisson 1.0 burstgpt './BurstGPT_GPT4-Conversation.csv' load 0 0 3 'burstgpt/INFaas++' $model
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 7.75 poisson 1.0 burstgpt './BurstGPT_GPT4-Conversation.csv' load 1 1 3 'burstgpt/Llumnix' $model

bash ./llumnix_exp_dataset ./config/serving_exp_dataset 8.00 poisson 1.0 burstgpt './BurstGPT_GPT4-Conversation.csv' balanced 0 0 3 'burstgpt/Round_Robin' $model
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 8.00 poisson 1.0 burstgpt './BurstGPT_GPT4-Conversation.csv' load 0 0 3 'burstgpt/INFaas++' $model
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 8.00 poisson 1.0 burstgpt './BurstGPT_GPT4-Conversation.csv' load 1 1 3 'burstgpt/Llumnix' $model

bash ./llumnix_exp_dataset ./config/serving_exp_dataset 8.25 poisson 1.0 burstgpt './BurstGPT_GPT4-Conversation.csv' balanced 0 0 3 'burstgpt/Round_Robin' $model
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 8.25 poisson 1.0 burstgpt './BurstGPT_GPT4-Conversation.csv' load 0 0 3 'burstgpt/INFaas++' $model
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 8.25 poisson 1.0 burstgpt './BurstGPT_GPT4-Conversation.csv' load 1 1 3 'burstgpt/Llumnix' $model

bash ./llumnix_exp_dataset ./config/serving_exp_dataset 8.50 poisson 1.0 burstgpt './BurstGPT_GPT4-Conversation.csv' balanced 0 0 3 'burstgpt/Round_Robin' $model
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 8.50 poisson 1.0 burstgpt './BurstGPT_GPT4-Conversation.csv' load 0 0 3 'burstgpt/INFaas++' $model
bash ./llumnix_exp_dataset ./config/serving_exp_dataset 8.50 poisson 1.0 burstgpt './BurstGPT_GPT4-Conversation.csv' load 1 1 3 'burstgpt/Llumnix' $model
