...
def main():
    input_file = "/workspace/llm-serve/Llumnix/benchmark_test/logs/L40-multi-port-zmp-parallel-test-2-pdd-4/llama-7b/poisson/serve_pdd_tp1_2000_qps_6_1_3.log"
    output_file = "/workspace/llm-serve/Llumnix/benchmark_test/logs/L40-multi-port-zmp-parallel-test-2-pdd-4/llama-7b/poisson/serve_pdd_tp1_2000_qps_6_1_3_sorted.log"
