...
try:
    from llumnix.llumlet.dcgm_bindings.python3.dcgm_structs import dcgmExceptionClass
    from llumnix.llumlet.dcgm_bindings.python3 import pydcgm, dcgm_agent, dcgm_structs, dcgm_fields, dcgmvalue
except ImportError as e:
    print(f"ImportError: {e}")
    print("Unable to find python bindings, please refer to the example below: ")
...
def main(manualOpMode=False, embeddedHostengine=True):
    ...
    print("Supported metric group: %s" % dcgmGroup.profiling.GetSupportedMetricGroups().metricGroups[1].fieldIds[0])
